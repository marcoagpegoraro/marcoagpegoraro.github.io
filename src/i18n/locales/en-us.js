export default {
    translations: {
      home: {
        message1: `Hello! My name is Marco, i'm a self taught backend developer currently working with Java, Spring boot, cloud, batch framework and Apache Kafka. I also have experience on Asp.NET tecnologies and front end development with angular and mobile development with Flutter and Ionic.`
      },
      projects:{
