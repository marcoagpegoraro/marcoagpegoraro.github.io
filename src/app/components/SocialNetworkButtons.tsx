...
export const SocialNetworkButtons = () => {
  return <>
    ...
    <IconButton href="https://www.credly.com/users/marco-antonio-goncalves-pegoraro" target="_blank" rel="noopener noreferrer" size="large" aria-label="menu" style={{ color: '#DD2A7B' }}>
      <img style={{ width: 24, height: 24, padding: 2, borderRadius: 7 }}
